    ...
    <header>
      ...
      {onScroll && (
        <div
          ...
          style={{ height: headerMenuRef.current?.clientHeight }}
        ></div>
      )}
      <div
        ref={headerMenuRef}
        className={clsx('w-full bg-white z-50', {
          'lg:shadow-md lg:fixed lg:top-0': onScroll,
        })}
      >
        <div className="flex content-center justify-between max-w-screen-xl flex-wrap lg:flex-nowrap lg:flex-row-reverse mx-auto lg:px-6">
          <span
            className="px-4 py-4 lg:hidden w-1/2"
          ...
          <div className="w-1/2 my-auto lg:w-fit">
            <div className="float-right relative pr-4 flex items-center">
              {onSearch && (
                <input
                  type="search"
          ...
          <ul
            className={clsx(
              'z-50 w-full px-4 flex-col border-b-2 border-gray-300 lg:border-b-0 lg:flex lg:flex-row lg:items-center lg:relative lg:top-0 lg:px-0 bg-white',
              {
                flex: isOpen,
                hidden: !isOpen,
              }
